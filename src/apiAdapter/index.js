// const BASE_URL = "https://warp-coffee-123.herokuapp.com/api";
...
export const getProductsByCategoryCountry = async (country) => {
  try {
    const response = await fetch(`${BASE_URL}/products/${country}`, {
      headers: {
        "Content-Type": "application/json",
      }
    });
